            ...
            for (var j = 0; j < that.matrix[i].length; j++) {
                if (that.matrix[i][j] != null) {
                    ...
                    if (that.matrix[i][j].draw_big_picture) {
                        ...
                        ctx.drawImage(player.faction.image, that.matrix[i][j].src_x, that.matrix[i][j].src_y, that.matrix[i][j].width, that.matrix[i][j].height, 200, 200, that.matrix[i][j].width, that.matrix[i][j].height);
                    }
