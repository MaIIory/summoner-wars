   ...
   */
    ...
    that.draw = function () { 
        ...
        if (that.type === 0)
            ...
            if(hor_diff != 0)
                ctx.drawImage(tmp_img, 0, 0, 260 + (arrow_len * board.square_w), 85, (board.square_w / 2) * (-1), (board.square_h / 2) * (-1), 260, 85);
            else
                ctx.drawImage(tmp_img, 0, 0, 170 + (arrow_len * board.square_h), 130, (board.square_h / 2) * (-1), (board.square_w / 2) * (-1), 170, 130);
