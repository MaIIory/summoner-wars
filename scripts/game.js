   ...
   */
    ...
    that.draw = function () { 
        ...
        if (that.type === 0)
            ...
            ctx.translate(board.s_x + (attacking_card_x * board.square_w) + (board.square_w / 2), board.s_y + (attacking_card_y * board.square_h) + (board.square_h / 2)); //change rotation point to the middle of the tank
